//Représentation d'un objet de type Signification

var SignificationModel = Backbone.Model.extend({

	defaults: {             // les valeurs par défaut des attributs

		// les attributs par défaut d'une signification
...
/*	sync: function (method, model, options) { // fonction sync spécifique au modèle
	...
	initialize : function() {
		console.log("modele signification crée");
	}
});
